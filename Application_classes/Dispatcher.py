...
from Translated_UI_Forms import Dispatcher_Form
...
class Dispatcher (QtGui.QMainWindow, Dispatcher_Form.Ui_Dispatcher_Form):
    ...
    def __init__ (self):
        ...
        Dispatcher_Form.Ui_Dispatcher_Form.setupUi(self, self)
