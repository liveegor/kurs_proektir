...
from Translated_UI_Forms import EditBreak_Form
...
class EditBreak (QtGui.QWidget, EditBreak_Form.Ui_EditBreak_Form):
    ...
    def __init__ (self):
        ...
        EditBreak_Form.Ui_EditBreak_Form.setupUi(self, self)
